...
const string strMessageMagic = "Vibranium Signed Message:\n";
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if(nHeight <= 20000)
    {
	 ...
	 else if(nHeight >= 40000 && nHeight < 85000  )
    {
        nSubsidy =  1 * COIN;
    }
		 else if(nHeight >= 85000 && nHeight < 125000  )
    {
        nSubsidy =  0.5 * COIN;
    }	 
		else if(nHeight >= 125000 && nHeight < 175000  )
    {
        nSubsidy =  0.25 * COIN;
    }
		else if(nHeight >= 175000 && nHeight < 225000  )
    {
        nSubsidy =  0.125 * COIN;
    }	
...
{
    RenameThread("Vibranium-loadblk");
