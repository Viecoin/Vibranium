...
int nAnonymizeVibraniumAmount = 500;
...
#else
    const char* pszModule = "Vibranium";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Vibranium
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Vibranium
    // Mac: ~/Library/Application Support/Vibranium
    // Unix: ~/.Vibranium
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vibranium";
#else
    fs::path pathRet;
