...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeVibraniumAmount"))
        settings.setValue("nAnonymizeVibraniumAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeVibraniumAmount = settings.value("nAnonymizeVibraniumAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeVibraniumAmount"))
        SoftSetArg("-anonymizeVibraniumamount", settings.value("nAnonymizeVibraniumAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeVibraniumAmount:
            nAnonymizeVibraniumAmount = value.toInt();
            settings.setValue("nAnonymizeVibraniumAmount", nAnonymizeVibraniumAmount);
            emit anonymizeVibraniumAmountChanged(nAnonymizeVibraniumAmount);
            break;
        default:
            break;
        }
